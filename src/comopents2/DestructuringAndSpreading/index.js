...
import Hp1 from "../../assets/level2immg/ejercicio6/ejercico6.png";
import Hp2 from "../../assets/level2immg/ejercicio6/ejercicio6-2.png";
  ...
  return (
    <>
      <div className="text-array">
        <h2>Destructuring and Spreading </h2>
